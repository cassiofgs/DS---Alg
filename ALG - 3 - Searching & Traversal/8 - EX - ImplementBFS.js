...
class BinarySearchTree {
    ...
    // Just for the sake of gaining more experience on recursive functions, because this way is really inefficient
    // We are using memory for a queue AND memory for the stack in recursive
    breadthFirstSearchRecursive(queue, result) {
        ...
        return this.breadthFirstSearch(queue, result);
    }
}
